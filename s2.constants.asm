...
; status.player.rolljumping		= 4 ; Jumping whilst rolling; locks the player's controls. (removed: roll-jump lock disabled)
...
Update_Bonus_score:		ds.b	1
				ds.b	1	; $FFFFF7D7 ; unused
Water_Ripple_Phase:		ds.w	1	; phase counter for LZ-style water ripple effect
